...
const App = component('App')
  ...
  .render(({ state, handlers }) => {
    const backdropStyle = 'position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.5);'
    const contentStyle = 'background:white;padding:2rem;max-width:400px;margin:auto;'
    const titleStyle = 'margin:0 0 1rem 0;'
    return (
      <div>
        ...
        {state.modalOpen() && (
          <div style={backdropStyle} data-testid='modal-backdrop' onclick={handlers.toggleModal}>
            <div style={contentStyle} data-testid='modal-content'>
