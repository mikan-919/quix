...
const App = component('App')
  ...
  .render(({ state, handlers }) => {
    ...
    const modalElement = state.modalOpen()
      ? <div onclick={handlers.toggleModal} style='position:fixed;inset:0;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;' data-testid='modal-backdrop'>
